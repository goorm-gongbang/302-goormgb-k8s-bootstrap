...
-- ============================================================
-- 3/28 (토) 14:00 KST = 05:00 UTC — ON_SALE
-- ============================================================
INSERT INTO matches (match_at, home_club_id, away_club_id, stadium_id, sale_status, created_at, updated_at) VALUES
('2026-03-28 05:00:00', 6,  9,  1, 'ON_SALE', NOW(), NOW()),  -- LG vs kt @ 잠실
('2026-03-28 05:00:00', 8,  10, 2, 'ON_SALE', NOW(), NOW()),  -- SSG vs KIA @ 문학
('2026-03-28 05:00:00', 2,  5,  3, 'ON_SALE', NOW(), NOW()),  -- 삼성 vs 롯데 @ 대구
('2026-03-28 05:00:00', 7,  1,  4, 'ON_SALE', NOW(), NOW()),  -- NC vs 두산 @ 창원
('2026-03-28 05:00:00', 4,  3,  5, 'ON_SALE', NOW(), NOW());  -- 한화 vs 키움 @ 대전

-- ============================================================
-- 3/29 (일) 14:00 KST = 05:00 UTC — ON_SALE
-- ============================================================
INSERT INTO matches (match_at, home_club_id, away_club_id, stadium_id, sale_status, created_at, updated_at) VALUES
('2026-03-29 05:00:00', 6,  9,  1, 'ON_SALE', NOW(), NOW()),  -- LG vs kt @ 잠실
('2026-03-29 05:00:00', 8,  10, 2, 'ON_SALE', NOW(), NOW()),  -- SSG vs KIA @ 문학
('2026-03-29 05:00:00', 2,  5,  3, 'ON_SALE', NOW(), NOW()),  -- 삼성 vs 롯데 @ 대구
('2026-03-29 05:00:00', 7,  1,  4, 'ON_SALE', NOW(), NOW()),  -- NC vs 두산 @ 창원
('2026-03-29 05:00:00', 4,  3,  5, 'ON_SALE', NOW(), NOW());  -- 한화 vs 키움 @ 대전

-- ============================================================
-- 3/31 (화) 18:30 KST = 09:30 UTC — UPCOMING
-- ============================================================
INSERT INTO matches (match_at, home_club_id, away_club_id, stadium_id, sale_status, created_at, updated_at) VALUES
('2026-03-31 09:30:00', 6,  10, 1, 'UPCOMING', NOW(), NOW()),  -- LG vs KIA @ 잠실
('2026-03-31 09:30:00', 8,  3,  2, 'UPCOMING', NOW(), NOW()),  -- SSG vs 키움 @ 문학
('2026-03-31 09:30:00', 2,  1,  3, 'UPCOMING', NOW(), NOW()),  -- 삼성 vs 두산 @ 대구
('2026-03-31 09:30:00', 7,  5,  4, 'UPCOMING', NOW(), NOW()),  -- NC vs 롯데 @ 창원
('2026-03-31 09:30:00', 4,  9,  5, 'UPCOMING', NOW(), NOW());  -- 한화 vs kt @ 대전

-- ============================================================
-- 4/1 (수) 18:30 KST = 09:30 UTC — UPCOMING
-- ============================================================
INSERT INTO matches (match_at, home_club_id, away_club_id, stadium_id, sale_status, created_at, updated_at) VALUES
('2026-04-01 09:30:00', 6,  10, 1, 'UPCOMING', NOW(), NOW()),
('2026-04-01 09:30:00', 8,  3,  2, 'UPCOMING', NOW(), NOW()),
('2026-04-01 09:30:00', 2,  1,  3, 'UPCOMING', NOW(), NOW()),
('2026-04-01 09:30:00', 7,  5,  4, 'UPCOMING', NOW(), NOW()),
('2026-04-01 09:30:00', 4,  9,  5, 'UPCOMING', NOW(), NOW());

-- ============================================================
-- 4/2 (목) 18:30 KST = 09:30 UTC — UPCOMING
-- ============================================================
INSERT INTO matches (match_at, home_club_id, away_club_id, stadium_id, sale_status, created_at, updated_at) VALUES
('2026-04-02 09:30:00', 6,  10, 1, 'UPCOMING', NOW(), NOW()),
('2026-04-02 09:30:00', 8,  3,  2, 'UPCOMING', NOW(), NOW()),
('2026-04-02 09:30:00', 2,  1,  3, 'UPCOMING', NOW(), NOW()),
('2026-04-02 09:30:00', 7,  5,  4, 'UPCOMING', NOW(), NOW()),
('2026-04-02 09:30:00', 4,  9,  5, 'UPCOMING', NOW(), NOW());

-- ============================================================
-- 4/3 (금) 18:30 KST = 09:30 UTC — UPCOMING
-- ============================================================
INSERT INTO matches (match_at, home_club_id, away_club_id, stadium_id, sale_status, created_at, updated_at) VALUES
('2026-04-03 09:30:00', 1,  4,  1, 'UPCOMING', NOW(), NOW()),  -- 두산 vs 한화 @ 잠실
('2026-04-03 09:30:00', 5,  8,  6, 'UPCOMING', NOW(), NOW()),  -- 롯데 vs SSG @ 사직
('2026-04-03 09:30:00', 9,  2,  7, 'UPCOMING', NOW(), NOW()),  -- kt vs 삼성 @ 수원
('2026-04-03 09:30:00', 10, 7,  8, 'UPCOMING', NOW(), NOW()),  -- KIA vs NC @ 광주
('2026-04-03 09:30:00', 3,  6,  9, 'UPCOMING', NOW(), NOW());  -- 키움 vs LG @ 고척

-- ============================================================
-- 4/4 (토) 17:00 KST = 08:00 UTC — UPCOMING
-- ============================================================
INSERT INTO matches (match_at, home_club_id, away_club_id, stadium_id, sale_status, created_at, updated_at) VALUES
('2026-04-04 08:00:00', 1,  4,  1, 'UPCOMING', NOW(), NOW()),
('2026-04-04 08:00:00', 5,  8,  6, 'UPCOMING', NOW(), NOW()),
('2026-04-04 08:00:00', 9,  2,  7, 'UPCOMING', NOW(), NOW()),
('2026-04-04 08:00:00', 10, 7,  8, 'UPCOMING', NOW(), NOW()),
('2026-04-04 08:00:00', 3,  6,  9, 'UPCOMING', NOW(), NOW());

-- ============================================================
-- 4/5 (일) 14:00 KST = 05:00 UTC — UPCOMING
-- ============================================================
INSERT INTO matches (match_at, home_club_id, away_club_id, stadium_id, sale_status, created_at, updated_at) VALUES
('2026-04-05 05:00:00', 1,  4,  1, 'UPCOMING', NOW(), NOW()),
('2026-04-05 05:00:00', 5,  8,  6, 'UPCOMING', NOW(), NOW()),
('2026-04-05 05:00:00', 9,  2,  7, 'UPCOMING', NOW(), NOW()),
('2026-04-05 05:00:00', 10, 7,  8, 'UPCOMING', NOW(), NOW()),
('2026-04-05 05:00:00', 3,  6,  9, 'UPCOMING', NOW(), NOW());

-- ============================================================
-- 4/7 (화) 18:30 KST = 09:30 UTC — UPCOMING
-- ============================================================
INSERT INTO matches (match_at, home_club_id, away_club_id, stadium_id, sale_status, created_at, updated_at) VALUES
('2026-04-07 09:30:00', 1,  3,  1, 'UPCOMING', NOW(), NOW()),  -- 두산 vs 키움 @ 잠실
('2026-04-07 09:30:00', 8,  4,  2, 'UPCOMING', NOW(), NOW()),  -- SSG vs 한화 @ 문학
('2026-04-07 09:30:00', 5,  9,  6, 'UPCOMING', NOW(), NOW()),  -- 롯데 vs kt @ 사직
('2026-04-07 09:30:00', 7,  6,  4, 'UPCOMING', NOW(), NOW()),  -- NC vs LG @ 창원
('2026-04-07 09:30:00', 10, 2,  8, 'UPCOMING', NOW(), NOW());  -- KIA vs 삼성 @ 광주

-- ============================================================
-- 4/8 (수) 18:30 KST = 09:30 UTC — UPCOMING
-- ============================================================
INSERT INTO matches (match_at, home_club_id, away_club_id, stadium_id, sale_status, created_at, updated_at) VALUES
('2026-04-08 09:30:00', 1,  3,  1, 'UPCOMING', NOW(), NOW()),
('2026-04-08 09:30:00', 8,  4,  2, 'UPCOMING', NOW(), NOW()),
('2026-04-08 09:30:00', 5,  9,  6, 'UPCOMING', NOW(), NOW()),
('2026-04-08 09:30:00', 7,  6,  4, 'UPCOMING', NOW(), NOW()),
('2026-04-08 09:30:00', 10, 2,  8, 'UPCOMING', NOW(), NOW());

-- ============================================================
-- 4/9 (목) 18:30 KST = 09:30 UTC — UPCOMING
-- ============================================================
INSERT INTO matches (match_at, home_club_id, away_club_id, stadium_id, sale_status, created_at, updated_at) VALUES
('2026-04-09 09:30:00', 1,  3,  1, 'UPCOMING', NOW(), NOW()),
('2026-04-09 09:30:00', 8,  4,  2, 'UPCOMING', NOW(), NOW()),
('2026-04-09 09:30:00', 5,  9,  6, 'UPCOMING', NOW(), NOW()),
('2026-04-09 09:30:00', 7,  6,  4, 'UPCOMING', NOW(), NOW()),
('2026-04-09 09:30:00', 10, 2,  8, 'UPCOMING', NOW(), NOW());

-- ============================================================
-- 4/10 (금) 18:30 KST = 09:30 UTC — UPCOMING
-- ============================================================
INSERT INTO matches (match_at, home_club_id, away_club_id, stadium_id, sale_status, created_at, updated_at) VALUES
('2026-04-10 09:30:00', 6,  8,  1, 'UPCOMING', NOW(), NOW()),  -- LG vs SSG @ 잠실
('2026-04-10 09:30:00', 2,  7,  3, 'UPCOMING', NOW(), NOW()),  -- 삼성 vs NC @ 대구
('2026-04-10 09:30:00', 9,  1,  7, 'UPCOMING', NOW(), NOW()),  -- kt vs 두산 @ 수원
('2026-04-10 09:30:00', 3,  5,  9, 'UPCOMING', NOW(), NOW()),  -- 키움 vs 롯데 @ 고척
('2026-04-10 09:30:00', 4,  10, 5, 'UPCOMING', NOW(), NOW());  -- 한화 vs KIA @ 대전
...
INSERT INTO matches (match_at, home_club_id, away_club_id, stadium_id, sale_status, created_at, updated_at) VALUES
('2026-04-11 08:00:00', 6,  8,  1, 'UPCOMING', NOW(), NOW()),
('2026-04-11 08:00:00', 2,  7,  3, 'UPCOMING', NOW(), NOW()),
('2026-04-11 08:00:00', 9,  1,  7, 'UPCOMING', NOW(), NOW()),
('2026-04-11 08:00:00', 3,  5,  9, 'UPCOMING', NOW(), NOW()),
('2026-04-11 08:00:00', 4,  10, 5, 'UPCOMING', NOW(), NOW());

-- 4/12 (일) 14:00 KST = 05:00 UTC
INSERT INTO matches (match_at, home_club_id, away_club_id, stadium_id, sale_status, created_at, updated_at) VALUES
('2026-04-12 05:00:00', 6,  8,  1, 'UPCOMING', NOW(), NOW()),
('2026-04-12 05:00:00', 2,  7,  3, 'UPCOMING', NOW(), NOW()),
('2026-04-12 05:00:00', 9,  1,  7, 'UPCOMING', NOW(), NOW()),
('2026-04-12 05:00:00', 3,  5,  9, 'UPCOMING', NOW(), NOW()),
('2026-04-12 05:00:00', 4,  10, 5, 'UPCOMING', NOW(), NOW());

-- 4/14 (화) 18:30 KST = 09:30 UTC
INSERT INTO matches (match_at, home_club_id, away_club_id, stadium_id, sale_status, created_at, updated_at) VALUES
('2026-04-14 09:30:00', 6,  5,  1, 'UPCOMING', NOW(), NOW()),
('2026-04-14 09:30:00', 8,  1,  2, 'UPCOMING', NOW(), NOW()),
('2026-04-14 09:30:00', 7,  9,  4, 'UPCOMING', NOW(), NOW()),
('2026-04-14 09:30:00', 10, 3,  8, 'UPCOMING', NOW(), NOW()),
('2026-04-14 09:30:00', 4,  2,  5, 'UPCOMING', NOW(), NOW());

-- 4/15 ~ 4/16
INSERT INTO matches (match_at, home_club_id, away_club_id, stadium_id, sale_status, created_at, updated_at) VALUES
('2026-04-15 09:30:00', 6,  5,  1, 'UPCOMING', NOW(), NOW()),
('2026-04-15 09:30:00', 8,  1,  2, 'UPCOMING', NOW(), NOW()),
('2026-04-15 09:30:00', 7,  9,  4, 'UPCOMING', NOW(), NOW()),
('2026-04-15 09:30:00', 10, 3,  8, 'UPCOMING', NOW(), NOW()),
('2026-04-15 09:30:00', 4,  2,  5, 'UPCOMING', NOW(), NOW()),
...
-- ============================================================
-- ON_SALE 경기에 match_seats 생성 (3/28, 3/29 전 경기)
-- ============================================================
